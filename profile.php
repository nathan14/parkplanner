...
<html lang="he">
  ...
  <head>
    ...
    <meta name="description" content="עדכון פרופיל משתמש באתר מתכנן הפארקים באורלנדו">
    <meta name="keywords" content="">
    <title>פרופיל - מתכנן הפארקים אורלנדו</title> 
  ...
  <body>
    ...
    <div class="container">
      ...
      <ol class="breadcrumb col-md-10 col-md-offset-1 hidden-xs">
        ...
        <li class="active" lang="he">פרופיל</li>
      </ol>
    
      <div class="col-md-10 col-md-offset-1 filters">
        <header>
          <h1 class="hidden-xs h1-modified" lang="he">פרופיל</h1>
        </header>                                       
        <form id="profile-form" novalidate>
          <div class="row">
            <div class="col-xs-12">
              ...
              <input dir="ltr" type="email" class="form-control input-lg white_click" name="email" id="email-profile">
            </div>          
            <div class="col-xs-6">
              <label class="form-label row-new" lang="he">שם פרטי</label>
              <input type="text" class="form-control input-lg white_click" name="fname-profile" id="fname-profile">
            </div>             
            <div class="col-xs-6">
              <label class="form-label row-new" lang="he">שם משפחה</label>
              <span id="email_label-status"></span>
              <input type="text" class="form-control input-lg white_click" name="lname-profile" id="lname-profile">
            </div>
            <div class="col-xs-12">
            ...
            <div class="col-xs-2 col-sm-4 col-md-3 pull-left">
              <button type="submit" class="btn btn-pink btn-block btn-lg hidden-xs" lang="he">עדכון פרטים</button>
            </div>
            <div class="col-sm-12">
              <button type="submit" class="btn btn-pink btn-lg visible-xs" lang="he">עדכון פרטים</button> 
            </div>
          </div>
        </form>
