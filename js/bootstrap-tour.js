  ...
  Tour = (function() {
    function Tour(options) {
      ...
      this._options = $.extend({
        ...
        delay: false,
        basePath: '',
        template: '<div class="popover" role="tooltip"> <div class="arrow"></div> <h3 class="popover-title"></h3> <div class="popover-content"></div> <div class="popover-navigation"> <div class="btn-group"> <button class="btn btn-md btn-general" data-role="prev">&laquo; הקודם</button> <button class="btn btn-md btn-general" data-role="next">הבא &raquo;</button> <button class="btn btn-sm btn-general" data-role="pause-resume" data-pause-text="עצור" data-resume-text="המשך">Pause</button> </div> <button class="btn btn-md btn-general" data-role="end">סיים</button> </div> </div>',
